...
const technologies: Tech[] = [
  ...
  // Cloud
  { name: "AWS", customPath: ICON_AWS, displayColor: "FF9900", url: "https://aws.amazon.com/" },
  { name: "Google Cloud", icon: siGooglecloud, url: "https://cloud.google.com/" },
  { name: "Azure", customPath: ICON_AZURE, displayColor: "0078D4", url: "https://azure.microsoft.com/" },
  ...
  // IA Cloud
  { name: "OpenAI", customPath: ICON_OPENAI, displayColor: "10A37F", url: "https://openai.com/" },
...
function iconFill(hex: string): string {
  ...
  if (brightness < 50) return "var(--muted)";
  return `#${hex}`;
}
    ...
    >
      ...
      >
        <div className="marquee-track">
          {doubled.map((tech, i) => {
            const path = tech.customPath ?? tech.icon?.path;
            const fill = tech.displayColor
              ? `#${tech.displayColor}`
              : tech.icon
              ? iconFill(tech.icon.hex)
              : "var(--muted)";
            ...
            return (
              <a
                ...
                className="inline-flex items-center gap-2 shrink-0 hover:opacity-75 transition-opacity"
              ...
              >
                ...
                <span
                  ...
                  style={{ color: "var(--accent-dim)", marginLeft: "4px" }}
                >
                  —
                </span>
              </a>
