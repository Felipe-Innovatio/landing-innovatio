      ...
      <div className="max-w-4xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight mb-6" style={{ color: "var(--foreground)", letterSpacing: "-0.03em" }}>
              Decisiones claras, <em style={{ fontStyle: "italic", color: "var(--accent)", fontWeight: "inherit" }}>inversiones inteligentes</em>
            </h1>
            <p className="text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: "var(--muted)" }}>
              ¿Sientes que tu tecnología te frena? Te ayudamos a tomar decisiones claras antes de invertir un peso. Auditoría técnica, revisión de código y roadmap de migración.
            </p>
          </div>
        </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="rounded-2xl p-8" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid var(--border)" }}>
              ...
              <div className="flex flex-wrap gap-2">
                {["Arquitectura", "Code Review", "Tech Strategy", "Revisión de Stack", "Mentoría"].map((t) => (
            ...
            <div className="rounded-2xl p-8" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid var(--border)" }}>
              ...
              <ul className="space-y-2">
                {["Auditoría técnica completa", "Recomendación de stack", "Revisión de código", "Roadmap de migración", "Mentoría técnica", "Documentación de arquitectura"].map((f) => (
        ...
        <ScrollReveal>
          <div className="rounded-2xl p-8 text-center mb-16" style={{ background: "rgba(55,138,221,0.04)", border: "1px solid var(--border)" }}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              <div><span className="text-3xl font-bold" style={{ color: "var(--accent)" }}>desde $200.000</span><span className="text-sm ml-2" style={{ color: "var(--muted)" }}>+ IVA</span></div>
              <div style={{ color: "var(--muted)" }}>|</div>
              <div style={{ color: "var(--muted)" }}>Por <strong style={{ color: "var(--foreground)" }}>sesión</strong></div>
            </div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <div className="rounded-2xl p-8 text-center" style={{ background: "rgba(55,138,221,0.04)", border: "1px solid rgba(55,138,221,0.15)" }}>
            <h2 className="text-2xl font-semibold mb-4" style={{ color: "var(--foreground)" }}>¿No sabes por dónde empezar?</h2>
            <p className="mb-6" style={{ color: "var(--muted)" }}>Agenda una sesión y te ayudamos a clarificar el camino.</p>
            <a href="/contacto" className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-medium text-sm transition-all hover:opacity-90 hover:scale-105" style={{ background: "var(--accent)", color: "#fff" }}>Agendar sesión →</a>
          </div>
        </ScrollReveal>
      </div>
